...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        // Creamos un mapa para almacenar la información de las naves espaciales (nombre, velocidad máxima, capacidad de pasajero, combustible disponible, oxigeno disponible)
